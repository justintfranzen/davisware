		...
		return array(
			...
			'borders'          => array(
				...
				'tooltip' => array(
					'css'          => array(
						'main' => array(
							'border_radii'  => '%%order_class%%.tippy-tooltip.dsm_image_hotspot_tooltip_wrapper',
							'border_styles' => '%%order_class%%.tippy-tooltip.dsm_image_hotspot_tooltip_wrapper',
						),
					),
					'label_prefix' => esc_html__( 'Tooltip', 'dsm-supreme-modules-pro-for-divi' ),
					'tab_slug'     => 'advanced',
			...
			'box_shadow'       => array(
				...
				'tooltip' => array(
					'css'          => array(
						'main' => '%%order_class%%.tippy-tooltip.dsm_image_hotspot_tooltip_wrapper',
					),
					'label_prefix' => esc_html__( 'Tooltip', 'dsm-supreme-modules-pro-for-divi' ),
					'tab_slug'     => 'advanced',
					'toggle_slug'  => 'tooltip_settings',
	...
	public function render( $attrs, $content, $render_slug ) {
		...
		if ( 'rgba(34,34,34,0.9)' !== $tooltip_background_color ) {
			...
			ET_Builder_Element::set_style(
				$render_slug,
				array(
					'selector'    => '.tippy-popper %%order_class%%.dsm_image_hotspot_tooltip_wrapper.tippy-tooltip>.tippy-arrow',
					'declaration' => sprintf(
						'color: %1$s;',
