...
class DSM_Advanced_Tabs extends ET_Builder_Module {
	...
	public function render( $attrs, $content, $render_slug ) {
		...
		return sprintf(
			'<div class="dsm-advanced-tabs-container" data-trigger="%3$s" data-animation="%4$s" data-inner_animation="%5$s" data-deep_link="%6$s" data-image_lightbox="%7$s" data-auto_scroll_mobile="%8$s">
				    %1$s
