<?php
	...
	class DiviMegaPro_Admin_Controller {
		...
		public static function divimegapros_displaysettings_callback( $post ) {
			...
			$dmp_enablecenterhorizontal = get_post_meta( $post->ID, 'dmp_enablecenterhorizontal' );
			...
			if ( !isset( $dmp_enablecenterhorizontal[0] ) ) {
				
				$dmp_enablecenterhorizontal[0] = '0';
			}
			?>
			<div class="divilife_meta_box">
				<p>
			...
			<div class="divilife_meta_box dmp_enablecenterhorizontal">
				<p>
					<input name="dmp_enablecenterhorizontal" type="checkbox" id="dmp_enablecenterhorizontal" value="1" <?php checked( $dmp_enablecenterhorizontal[0], 1 ); ?> /> <?php esc_html_e( 'Center Horizontally', 'DiviMegaPro' ); ?>
				</p>
			</div>
		...
		public static function save_post( $post_id, $post ) {
			...
			/* Mega Pro Center Horizontally */
			if ( isset( $_POST['dmp_enablecenterhorizontal'] ) ) {
				
				$dmp_enablecenterhorizontal = 1;
				
			} else {
				
				$dmp_enablecenterhorizontal = 0;
			}
			update_post_meta( $post_id, 'dmp_enablecenterhorizontal', $dmp_enablecenterhorizontal );
